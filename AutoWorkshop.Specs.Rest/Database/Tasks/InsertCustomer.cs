namespace AutoWorkshop.Specs.Rest.Database.Tasks
{
    ...
    public class InsertCustomer : DatabaseTask
    {
        ...
        private bool _hasAccountInvoicing;
        ...
        public InsertCustomer WithAccountInvoicingSetTo(bool value)
        {
            _hasAccountInvoicing = value;
            return this;
        }
        ...
        protected override void PerformAs(IActor actor, string connectionString)
        {
            ...
            connection.Execute(@"
                ...
                new
                {
                    ...
                    mobile = _mobile,
                    accountInvoicing = _hasAccountInvoicing ? 1 : 0
                });
        }
    }
}
